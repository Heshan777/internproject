  ...
  return (
    <Box sx={{ width: '100%', maxWidth: 420, px: { xs: 2, lg: 6 } }}>
      ...
      <Typography sx={{ mt: 4, textAlign: 'center', fontSize: 12, color: '#6b7280' }}>
        Not a member?{' '}
        <Link href="#" underline="hover" sx={{ fontWeight: 700, color: '#16a34a' }}>
          Register now
        </Link>
      </Typography>
      ...
      <Box sx={{ mt: 4, textAlign: { xs: 'center', lg: 'left' } }}>
        <Typography sx={{ fontSize: 12, color: '#6b7280' }}>
          46, Lauries Road, Colombo 00400, Sri Lanka
        </Typography>
        <Typography sx={{ fontSize: 12, color: '#6b7280' }}>(+94) 77 123 6952</Typography>
        <Typography sx={{ fontSize: 12, color: '#6b7280' }}>support@code3x.tech</Typography>
      </Box>
    </Box>
  )
}